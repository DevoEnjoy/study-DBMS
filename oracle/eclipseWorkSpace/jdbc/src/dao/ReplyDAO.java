...
//   댓글 삭제
   public void deleteDepth1(Long replyId) {
...
//   댓글 삭제
   public void deleteDepth0(Long replyId) {
//	   String query0 = "DELETE FROM TBL_REPLY WHERE REPLY_GROUP = ?";
//	   String query1 = "DELETE FROM TBL_REPLY WHERE REPLY_ID = ?";
   ...
   public void delete(ReplyVO replyVO) {
	   String query0 = "DELETE FROM TBL_REPLY WHERE REPLY_GROUP = ?";
	   String query1 = "DELETE FROM TBL_REPLY WHERE REPLY_ID = ?";
	   boolean isParentReply = replyVO.getReplyGroup() == replyVO.getReplyId();
	   connection = DBConnecter.getConnection();
	   try {
		   preparedStatement = connection.prepareStatement(isParentReply ? query0 : query1);
		   preparedStatement.setLong(1, replyVO.getReplyId());
...
//   댓글 수정
   public void update(ReplyVO replyVO) {
		String query = "UPDATE TBL_REPLY SET REPLY_UPDATE_DATE = SYSDATE, REPLY_CONTENT = ? "
