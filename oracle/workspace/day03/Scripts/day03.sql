...
HIRE_DATE BETWEEN '2003-01-01' AND '2005-12-31';
...
SELECT H.HEIGHT, P.PLAYER_NAME , P.TEAM_ID  FROM PLAYER P
JOIN 
(
	SELECT MAX(HEIGHT) HEIGHT, TEAM_ID 
	FROM PLAYER
...
ON P1.HEIGHT = P2.HEIGHT AND P1.TEAM_ID = P2.TEAM_ID;*/
...
SELECT LEVEL, LPAD('	',(LEVEL-1)*5) || LAST_NAME 계층화, EMPLOYEE_ID 사번, MANAGER_ID "매니저 번호" 
FROM EMPLOYEES e 
START WITH MANAGER_ID IS NULL
CONNECT BY PRIOR EMPLOYEE_ID = MANAGER_ID ;
--==========================
